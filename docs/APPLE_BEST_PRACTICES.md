...
**Ações no projeto:** recompilar com Xcode 26; migrar VStack/HStack custom para componentes padrão; glass apenas nos overlays do preview.
...
**Ações:** quebrar `ContentView.swift` (~80 KB) em cenas menores; `MenuBarExtra` para controle rápido; onboarding BLE guiado.
